...
export default function TermsOfServicePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full px-4 py-12 bg-slate-50/60 dark:bg-[#03060F] transition-colors duration-300 relative overflow-hidden text-slate-800 dark:text-gray-200">
      ...
      <div className="w-full max-w-2xl space-y-6 relative z-10">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center gap-2 text-sm font-bold text-slate-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors py-2 px-4 rounded-2xl bg-white/80 dark:bg-neutral-900/60 border border-slate-200/80 dark:border-white/[0.08] backdrop-blur-md shadow-xs"
        >
          <ArrowLeft size={16} /> Back to Login
        </Link>

        {/* Content Card with Frosted Glass & Delicate Border */}
