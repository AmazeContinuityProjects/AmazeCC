  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-black flex items-center justify-center p-4 sm:p-6 transition-all duration-300">
      <div className="w-full max-w-md mx-auto">
        ...
        {/* Step content */}
        <div className="bg-white dark:bg-[#0a0a0a] border border-gray-200 dark:border-gray-800 rounded-3xl p-5 sm:p-7 shadow-xl transition-all duration-300 overflow-hidden">
            ...
            >
              ...
              {steps[step] === "profile" && (
                <div className="space-y-5">
                  ...
                  {/* Residential Status Radio Group */}
                  <div className="space-y-1.5">
              ...
              {steps[step] === "personalization" && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="p-3 rounded-xl border border-gray-200 dark:border-gray-800 bg-gray-50/30 dark:bg-neutral-900/20 space-y-2.5">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-xs font-extrabold text-gray-900 dark:text-white">Push Notifications</p>
                          <p className="text-[10px] text-gray-500 dark:text-gray-400">Class & deadline reminders.</p>
                        </div>
                        <button
                          type="button"
                          onClick={enableNotifications}
                          disabled={notifEnabled || notifLoading}
                          className="px-3 py-1.5 rounded-lg text-[10px] font-black border transition-all disabled:opacity-60"
                          style={{
                            borderColor: notifEnabled ? "#10b981" : accentVal,
                            backgroundColor: notifEnabled ? "#10b98115" : `${accentVal}15`,
                            color: notifEnabled ? "#10b981" : accentVal,
                          }}
                        >
                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center justify-between">
                      <label className="text-xs font-bold text-gray-750 dark:text-gray-300 uppercase tracking-wider">Quick Pinned Tabs</label>
                      <span className="text-[9px] text-gray-400 font-bold uppercase">Max 4 tabs</span>
                    </div>
