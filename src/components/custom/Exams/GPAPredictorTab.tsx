  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="bg-white dark:bg-slate-900 midnight:bg-black shadow-sm">
          <CardHeader className="pb-3 border-b dark:border-slate-800 midnight:border-gray-800">
            <CardTitle className="flex items-center gap-2 text-lg">
              <Target className="w-5 h-5 text-blue-500" />
              Target CGPA Calculator
            </CardTitle>
            <CardDescription>Find out what SGPA you need to hit your goal.</CardDescription>
          </CardHeader>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-2 border rounded-lg bg-white dark:bg-slate-800 midnight:bg-black dark:border-slate-700 midnight:border-gray-800 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                />
                <button
                  onClick={saveGoal}
                  disabled={!targetCgpa || !isTargetPossible}
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg flex items-center gap-2 font-medium transition-colors"
                >
            ...
            {targetCgpaNum > 0 && (
              <div className={`p-4 rounded-xl border ${
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Required SGPA this semester</p>
        ...
        <Card className="bg-white dark:bg-slate-900 midnight:bg-black shadow-sm">
          <CardHeader className="pb-3 border-b dark:border-slate-800 midnight:border-gray-800">
            ...
            <CardDescription>Estimate your GPA based on expected grades.</CardDescription>
          </CardHeader>
          <CardContent className="pt-5">
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-800 midnight:bg-gray-900 rounded-xl mb-6">
              <div className="text-center">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">Predicted SGPA</p>
                <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{predictedSgpa.toFixed(2)}</p>
              </div>
              <ArrowRight className="w-6 h-6 text-gray-300" />
              <div className="text-center">
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">New CGPA</p>
                <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{predictedCgpa.toFixed(2)}</p>
              </div>
            </div>
                ...
                currentCourses.map(course => (
                  <div key={course.baseCode} className="flex items-center justify-between p-3 rounded-lg border border-gray-100 dark:border-slate-800 midnight:border-gray-800 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                    <div className="flex-1 pr-4">
                      <p className="font-semibold text-sm text-gray-900 dark:text-gray-100">{course.baseCode}</p>
